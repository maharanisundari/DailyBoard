// Minggu 15 - Refactoring ke Module
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Minggu 2 - Judul & Pengingat Waktu
    const judul = document.createElement("h2");
    judul.textContent = "Selamat datang di DailyBoard!";
    judul.style.color = "var(--primary)";
    app.appendChild(judul);

    const elWaktu = document.createElement("div");
    elWaktu.id = "pengingat-waktu";
    elWaktu.style.cssText =
        "font-size: 1rem; font-weight: 600; text-align: center; color: var(--primary); margin-bottom: 1rem;";
    app.appendChild(elWaktu);
    ...
    txtCatatan.placeholder = "Tulis catatan...";
    ...
    function tampilkanKutipan() {
        ...
        ambilKutipan()
            ...
            .catch(err => {
                ...
                elKutipan.textContent =
                    "⚠️ Tidak dapat memuat kutipan saat ini.";
    ...
    function tampilkanCuaca(namaKota) {
        ...
        divInfoCuaca.innerHTML =
            `<p>⏳ Memuat cuaca untuk <strong>${namaKota}</strong>...</p>`;
            ...
            .then(data => {
                ...
                divInfoCuaca.innerHTML = `
                    <div>
                        ...
                        <p>🌡️ Suhu: ${c.temperature}°C</p>
                        <p>💨 Kecepatan Angin: ${c.windspeed} km/jam</p>
                    </div>
                `;
            })
            .catch(err => {
    ...
    function muatSemuaWidget() {
        ...
        return Promise.all([
            ...
            console.log("Semua widget API berhasil dimuat.");
        });
    }
    ...
    toggleTema.textContent = "Ganti Tema";

    app.insertBefore(toggleTema, app.firstChild);

    toggleTema.onclick = function() {
